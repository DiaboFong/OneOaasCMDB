...
<head>
    ...
    <link rel="stylesheet" href="assets/scripts/pdf/web/viewer.css">
    <script src="assets/scripts/pdf/web/compatibility.js"></script>
    <!-- This snippet is used in production (included from viewer.html) -->
    <link rel="resource" type="application/l10n" href="assets/scripts/pdf/web/locale/locale.properties">
    <script src="assets/scripts/pdf/web/l10n.js"></script>
    <script src="assets/scripts/pdf/build/pdf.js"></script>
    <script src="assets/scripts/pdf/web/debugger.js"></script>
    <script src="assets/scripts/pdf/web/viewer.js"></script>
